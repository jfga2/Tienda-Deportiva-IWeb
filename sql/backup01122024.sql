...
1	Barcelona	\N
2	Madrid	\N
3	Valencia	Equipo de Valencia
4	Lakers	
5	Ciencia	Equipo científico
6	Matemáticas	Equipo de matemáticas
\.
...
1	t	f	admin@ua.es	2001-08-31	Admin	123
\.
...
SELECT pg_catalog.setval('public.tareas_id_seq', 20, true);
